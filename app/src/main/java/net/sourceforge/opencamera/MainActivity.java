...
public class MainActivity extends Activity implements View.OnDragListener, View.OnLongClickListener {
    ...
    public static MainUI mainUI;//요놈
    private ManualSeekbars manualSeekbars;
    public static MyApplicationInterface applicationInterface;//요놈
    private TextFormatter textFormatter;
    private SoundPoolManager soundPoolManager;
    private MagneticSensor magneticSensor;
    private SpeechControl speechControl;

    public static Preview preview;//요놈
...
//        ImageView gallery_cp = (ImageView) findViewById(R.id.gallery_cp);
...
//        switch_video_cp.setOnLongClickListener(this);
        ...
        findViewById(R.id.layout2_1).setOnDragListener(this);
        findViewById(R.id.layout2_2).setOnDragListener(this);
        findViewById(R.id.layout2_3).setOnDragListener(this);
        findViewById(R.id.layout2_4).setOnDragListener(this);

        findViewById(R.id.layout3_1).setOnDragListener(this);
        findViewById(R.id.layout3_2).setOnDragListener(this);
        findViewById(R.id.layout3_3).setOnDragListener(this);
        findViewById(R.id.layout3_4).setOnDragListener(this);

        findViewById(R.id.layout4_1).setOnDragListener(this);
        findViewById(R.id.layout4_2).setOnDragListener(this);
        findViewById(R.id.layout4_3).setOnDragListener(this);
        findViewById(R.id.layout4_4).setOnDragListener(this);
        //kylee_end
...
//        myToast.show();
     ...
     */
    public void ClickedAddBtn(View view) {
        addBtn();
        //findViewById(R.id.blur_frame).setBackgroundColor(0x00000000);
        //findViewById(R.id.blur_frame).setBackgroundColor(0x00000000);
    }
    ...
    public void takePicture(boolean photo_snapshot) {
        if (MyDebug.LOG)
            Log.d(TAG, "takePicture" + applicationInterface.getPhotoMode());
...
//                    Toast.makeText(this, "The drop didn't work.", Toast.LENGTH_SHORT).show();
    ...
    public void functionCall(String s, View view) {
        switch (s) {
            case "0":
                clickedGallery(view);
                ;
            ...
            case "2":
                ...
                break;
            case "3":
                clickedSwitchVideo(view);
                ;
                break;
            case "4":
                clickedExposureLock(view);
                ;
                break;
